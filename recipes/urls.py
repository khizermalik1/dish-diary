...
urlpatterns = [
    ...
    path("<slug:slug>/comment/", views.comment_recipe, name="comment_recipe"),
    path("<slug:slug>/like/", views.like_recipe, name="like_recipe"),
    path("latest-recipes/", views.latest_recipes, name="latest_recipes"),
    path("search/", views.search_recipes, name="search_recipes"),
    path("user/<str:username>/", views.user_profile, name="user_profile"),
    path("profile/edit/", views.edit_profile, name="edit_profile"),
    path("explore-chefs/", views.explore_chefs, name="explore_chefs"),
    path("recipes/<slug:slug>/save/",
         views.toggle_favourite, name="toggle_favourite"),
    path("favourites/", views.saved_recipes, name="saved_recipes"),
]
